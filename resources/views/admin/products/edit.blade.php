...
@section('content')
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            @endif
            <form role="form" id="form" action="{{ route('products.update',$product->id) }}" enctype="multipart/form-data"
                  method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="detail" id="inputDescription" class="form-control" rows="4">{{ $product->detail }}</textarea>
                    </div>
                    <div class="col-md-12">
...
{{--                                <input type="text" id="inputName" name="loaisp" class="form-control" value="{{ $product->loaisp}}">--}}
                        ...
                        <div class=" float-md-right col-md-3">
                            <img id="output_image" alt="" class="img-circle" src="{{asset('img/'.$product->image)}}"
