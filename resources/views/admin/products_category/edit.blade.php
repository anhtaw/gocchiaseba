...
@section('active')
    ...
    <li class="nav-item has-treeview">
        ...
        <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a href="{{ route('products_category.create')}}" class="nav-link ">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm sản phẩm</p>
                </a>
            </li>
...
@section('content')
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            @endif
            <form role="form" id="form" action="{{ route('products_category.update',$products_category->id) }}" enctype="multipart/form-data"
                  method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="inputName" name="name_category" class="form-control" value="{{ $products_category->name_category }}">
                    </div>
