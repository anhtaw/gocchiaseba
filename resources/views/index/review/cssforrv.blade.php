...
.vc_custom_1500708262499 {
    margin-right: -4.5rem !important;
    margin-left: -4.5rem !important;
}

.vc_custom_1500709802445 {
    margin-top: -22em !important;
    background-color: #f0f0ed !important;
}

        .vc_custom_1500711617511 {
            background-image: url({{ asset('img/10.png') }}) !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        }

        .vc_custom_1496047996415 {
            background-color: #f0f0ed !important;
        }

        .vc_custom_1500708919986 {
            margin-bottom: 2.85rem !important;
        }

        .vc_custom_1500708941450 {
            margin-bottom: -1rem !important;
        }

        .vc_custom_1500708238643 {
            margin-left: 3.7rem !important;
        }

        .vc_custom_1500708286428 {
            margin-top: 4rem !important;
            margin-left: -3.7rem !important;
        }
        .vc_custom_1500710018993 {
            margin-bottom: 0.8rem !important;
        }

        .vc_custom_1500711522715 {
            margin-bottom: -2.1rem !important;
        }

        .vc_custom_1500711552929 {
            margin-bottom: 4.6rem !important;
        }

        .vc_custom_1500713139873 {
            margin-bottom: 2.85rem !important;
        }

        .vc_custom_1500713468778 {
            margin-bottom: 1.2rem !important;
        }

        .vc_custom_1500713766609 {
            margin-bottom: 2.6rem !important;
        }

        .vc_custom_1568815772324 {
            margin-bottom: 9.6rem !important;
        }

        .vc_custom_1500713826575 {
            margin-top: -9rem !important;
        }

        .vc_custom_1500714881188 {
            margin-bottom: 0.3rem !important;
        }

        .vc_custom_1500714899049 {
            margin-bottom: 4.6rem !important;
        }
    </style>
 <link property="stylesheet" rel='stylesheet' id='wc-block-style-css' href="<?php echo asset('css/woocommerce/packages/woocommerce-blocks/build/style.css')?>" type='text/css' media='all'/>
