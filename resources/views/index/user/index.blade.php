...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="Mendel Antiques. Furniture Design and Restoration &raquo; Feed" href="<?php echo asset('index/index1.rss')?>"/>
    <link rel="alternate" type="application/rss+xml" title="Mendel Antiques. Furniture Design and Restoration &raquo; Comments Feed" href="<?php echo asset('index/index2.rss')?>"/>
    <link rel="alternate" type="application/rss+xml" title="Mendel Antiques. Furniture Design and Restoration &raquo; Home 2 Comments Feed" href="<?php echo asset('index/index3.rss')?>"/>
    ...
    <link property="stylesheet" rel='stylesheet' id='trx_demo_panels-css'
          ...
          type='text/css' media='all'/>
    <link property="stylesheet" rel='stylesheet' id='select2-css'
          href='http://mendel-antiques.ancorathemes.com/wp-content/plugins/woocommerce/assets/css/select2.css?ver=4.0.1'
          type='text/css' media='all'/>
...
<!--[if lt IE 9]>
    ...
    <script type='text/javascript'
            src='http://mendel-antiques.ancorathemes.com/wp-includes/js/zxcvbn-async.min.js?ver=1.0'></script>
    <script type='text/javascript'
    ...
    href="http://mendel-antiques.ancorathemes.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fmendel-antiques.ancorathemes.com%2Fmy-account%2F"/>
        <link rel="alternate" type="text/xml+oembed"
    href="http://mendel-antiques.ancorathemes.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fmendel-antiques.ancorathemes.com%2Fmy-account%2F&#038;format=xml"/>
        <script type="text/javascript">
    ...
    <link rel="icon"  href="{{ asset('img/iconindex/cropped-512x512-favicon-32x32.jpg') }}"   sizes="32x32"/>
    <link rel="icon" href="{{ asset('img/iconindex/cropped-512x512-favicon-192x192.jpg') }}" sizes="192x192"/>
    <link rel="apple-touch-icon-precomposed" href="{{ asset('img/iconindex/cropped-512x512-favicon-180x180.jpg') }}"/>
    <meta name="msapplication-TileImage" content="{{ asset('img/iconindex/cropped-512x512-favicon-270x270.jpg') }}"/>
    ...
    <style type="text/css" id="trx_addons-inline-styles-inline-css">.vc_custom_1500893297996 {
...
<body
    class="page-template-default page page-id-495 theme-mendel woocommerce-account woocommerce-page woocommerce-no-js body_tag scheme_default blog_mode_shop body_style_wide  is_stream blog_style_excerpt sidebar_hide expand_content header_style_header-custom-21 header_position_default menu_style_top no_layout wpb-js-composer js-comp-ver-6.0.5 vc_responsive">
@if (Auth::check())
@else
    <div class="body_wrap">
        ...
        <div class="page_wrap">
            <header
                class="top_panel top_panel_custom top_panel_custom_21 top_panel_custom_header-fullwidth-simple without_bg_image scheme_default">
                <div
                        ...
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <div class="sc_layouts_item">
                                    <a href="{{ route('index.index')}}" id="sc_layouts_logo_254021780"
                                       class="sc_layouts_logo sc_layouts_logo_default">
                                        <img class="logo_image" src="{{ asset('img/img/logoheader.png') }}" alt=""
                                             width="240" height="42"></a><!-- /.sc_layouts_logo -->
                                </div>
                            </div>
                        </div>
                    </div>
                    <div
                        class="wpb_column vc_column_container vc_col-sm-6 sc_layouts_column sc_layouts_column_align_center sc_layouts_column_icons_position_left">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                <div class="sc_layouts_item">
                    ...
                    <div
                        class="wpb_column vc_column_container vc_col-sm-3 vc_hidden-sm vc_hidden-xs sc_layouts_column sc_layouts_column_align_right sc_layouts_column_icons_position_left">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                    ...
                                    <div id="sc_layouts_iconed_text_1293513101" class="sc_layouts_iconed_text">
                                        <a href="{{ route('ad.index')}}"
                                           class="sc_layouts_item_link sc_layouts_iconed_text_link">
                                            <span
                                                class="sc_layouts_item_icon sc_layouts_iconed_text_icon icon-user"></span>
                                        </a>
				...
				<span class="sc_layouts_cart_summa">&#36;0.00</span>
                                ...
                                <div class="sc_layouts_item">
                                    <div id="sc_layouts_iconed_text_171639584" class="sc_layouts_iconed_text">
                                        <a href="mailto:ducgets@gmail.com"
                                           class="sc_layouts_item_link sc_layouts_iconed_text_link">
                                            <span
                                                class="sc_layouts_item_icon sc_layouts_iconed_text_icon icon-mail-1"></span>
                                        </a>
                                    </div><!-- /.sc_layouts_iconed_text -->
                                </div>
                                <div class="sc_layouts_item">
                                    <div id="sc_layouts_search_1313918430" class="sc_layouts_search">
                                                    ...
                                                    <div class="sc_layouts_title_breadcrumbs">
                                                        <div class="breadcrumbs">
                                                            <a class="breadcrumbs_item home"
                                                               href="{{route('index.index')}}">Trang Chủ</a>
                                                            {{--                                    <span class="breadcrumbs_delimiter"></span><a href="{{ route('ad.index')}}">Rao Vặt</a>--}}
                                                            <span class="breadcrumbs_delimiter"></span><span
                                                                class="breadcrumbs_item current">Tài Khoản</span>
                                                        </div>
                                                    </div>
        ...
        <div class="page_content_wrap scheme_default">
            <div class="content_wrap">
                <div class="content">
                    <article id="post-495"
                             class="post_item_single post_type_page post-495 page type-page status-publish hentry">
                            ...
                            <div class="woocommerce">
                                ...
                                <form class="woocommerce-form woocommerce-form-login login" method="post"
                                    ...
                                    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                        ...
                                        <input class=" woocommerce-Input--text input-text" type="password" name="password" id="password"
                                               autocomplete="current-password"  onclick="myFunction()" />
                                    </p>
    ...
    <script type='text/javascript'
            src='http://mendel-antiques.ancorathemes.com/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min.js?ver=1.0.6'></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
        var pwsL10n = {
    ...
    <script type='text/javascript'
            src='http://mendel-antiques.ancorathemes.com/wp-admin/js/password-strength-meter.min.js?ver=5.3.2'></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
    ...
    <script type='text/javascript'
            src='http://mendel-antiques.ancorathemes.com/wp-content/plugins/woocommerce/assets/js/frontend/password-strength-meter.min.js?ver=4.0.1'></script>
    <script type='text/javascript'
