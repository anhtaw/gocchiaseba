                                            ...
                                            <div class="sc_layouts_title_content">
                                                ...
                                                <div class="sc_layouts_title_breadcrumbs">
                                                    <div class="breadcrumbs">
                                                        ...
                                                        <span class="breadcrumbs_delimiter"></span><a
                                                            href="{{ route('ad.index')}}">Mua bán</a>
                                                        <span class="breadcrumbs_delimiter"></span><span
                                                            class="breadcrumbs_item current">Đăng Ký</span>
                                                    </div>
                                                </div>
                    ...
                    <div class="post_content entry-content">
                            ...
                            <form class="woocommerce-form woocommerce-form-login login" method="POST"
                                ...
                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                    ...
                                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text"
                                           name="name" id="username" autocomplete="username" value=""/></p>
                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        ...
                        <strong>{{ $message }}</strong>
                                ...
                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                    ...
                                    <input
                                        class=" woocommerce-Input--text input-text  @error('password') is-invalid @enderror"
                                        type="password" name="password" id="password" required
                                        autocomplete="new-password" autocomplete="current-password" onclick="myFunction()" onkeyup='check();'/>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                    ...
                                    <input class=" woocommerce-Input--text input-text" type="password"
                                           onclick="myFunction1()" name="confirm_password" id="confirm_password" autocomplete="current-password"/>
                                ...
                                <p class="form-row">
                                    ...
                                    <button type="submit"
                                            ...
                                            name="registration" value="registration"   id="submit" disabled>Đăng Ký
                                    </button>
                                </p>
